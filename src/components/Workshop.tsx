...
export const Workshop: React.FC<WorkshopProps> = ({ onGoToHome }) => {
          ...
          const offset = currentMission.obstacles.find(
            (obs) =>
              obs.x ===
                step.fromState.x +
                  (step.command === 'STEP'
                    ? step.fromState.direction === 'EAST'
                      ? 1
                      : step.fromState.direction === 'WEST'
                      ? -1
                      : 0
                    : 0) &&
              obs.y ===
                step.fromState.y +
                  (step.command === 'STEP'
                    ? step.fromState.direction === 'SOUTH'
                      ? 1
                      : step.fromState.direction === 'NORTH'
                      ? -1
                      : 0
                    : 0)
          );
